  ...
  return (
    <div className="text-three bg-five pt-16">
      ...
      <div className="flex justify-center items-center gap-2 md:px-28 lg:px-10 md:gap-5">
        ...
        {handleButton == 0 && (
          <>
            <div className="md:pl-10 w-2/5 md:w-2/4 lg:w-1/4">
              <img
                src="/images/qNF.jpg"
                alt="card"
            ...
            <div className="md:pr-10">
              <div className="text-xs md:text-2xl">
                <h1 className="text-four">
                  Nora Fatehi <span className="text-three">for</span>
                </h1>
                <h1>an event hosted</h1>
                <h1>by XYZ </h1>
                <h1>
                  performed <span className="text-four">at Pune.</span>
                </h1>
              </div>
              <div className="flex justify-start items-center pt-3 text-xs md:text-2xl">
                <img
        ...
        {handleButton == 1 && (
          <>
            ...
            <div className="md:pr-10">
              <div className="text-xs md:text-2xl">
                <h1 className="text-four">
                  Kapil Sharma <span className="text-three">for</span>
                </h1>
                <h1>an event hosted</h1>
                <h1>by XYZ </h1>
                <h1>
        ...
        {handleButton == 2 && (
          <>
            ...
            <div className="md:pr-10">
              <div className="text-xs md:text-2xl">
                <h1 className="text-four">
                  Zakir Khan <span className="text-three">for</span>
                </h1>
                <h1>an event hosted</h1>
                <h1>by XYZ </h1>
                <h1>
