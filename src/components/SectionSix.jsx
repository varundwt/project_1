    ...
    <div className="bg-gradient-to-b from-five from-10% via-eleven via-50% to-five text-three pb-20">
      ...
      <div className="flex flex-col justify-center items-center border-2 border-eleven rounded-3xl lg:rounded-full  bg-five bg-opacity-40 backdrop-blur-lg">        
        ...
        <div className="px-1 text-xs md:text-md py-6 text-center">
          From passion-driven dedication to impactful contribution, <br /> we do
          it all here. We are growing and will be excited to hear <br /> from
          you!
        </div>
        ...
        <div className="flex pb-5 md:gap-1">
            <div><button className=" text-three bg-five rotate-12 bg-opacity-40 backdrop-blur-lg rounded-3xl px-3 py-1 text-xs md:text-sm font-light hover:scale-105 transition-all duration-500 cursor-pointer">
            Focused
          </button></div>
            <div><button className=" text-three bg-five -rotate-12 bg-opacity-40 backdrop-blur-lg rounded-3xl px-3 py-1 text-xs md:text-sm font-light hover:scale-105 transition-all duration-500 cursor-pointer">
            Collaborative
